...
# y = label_encoder.fit_transform(y)  # Encode target
 
# # #Save DataSet
# # dset=X
# # dset["target"]=y
# # dset.to_csv("BCWC.csv", index=False)
...
plt.title('Correlation between Breast Cancer and Numeric Features')
...
comparison_df.to_csv("BCWC_comparison.csv", index=False)
print("\nSaved to: BCWC_comparison.csv")